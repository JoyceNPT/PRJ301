<%-- 
    ...
    Created on : Feb 23, 2025, 9:09:59 PM
    Author     : ngoth
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container" style="margin-top: 3%;">
            <h1 style="font-weight: 400;" value='Create new movie'>Create new movie</h1>
            ...
            <%
                if(request.getMethod().equalsIgnoreCase("POST")) {
                    ...
                    boolean create = dao.create(title, director, release_year, rating, Is_rented);
                    
                    if(create) {
                        response.sendRedirect("movies.jsp");
                    } else {
                        out.println("<h1 style='color: red; text-align: center;'>Create Data Failed</h1>");
                    }
                }
            %>
